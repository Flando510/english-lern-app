...
async function renderLearning() {
  ...
  // WICHTIG:
  // Nicht learningArea überschreiben!
  // Die Klassen- und Modus-Buttons befinden sich dort.
  // Nur contentArea wird verändert.
...
async function renderExercise() {
  ...
  if (!words.length) {
    ...
    contentArea.innerHTML = `
      ...
      <p>
        Für diese Klasse sind noch keine Vokabeln vorhanden.
      </p>
